...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NMPD] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______,                         _______, KC_NLCK, KC_CALC, KC_PSLS, KC_PAST, KC_PMNS, _______,
  ...
  [FUNC] = LAYOUT(
    ...
    _______, RESET,   RGB_M_P, RGB_M_TW, RGB_MR,           KC_PSCR, _______,       _______, _______,          RGB_MR,  RGB_M_TW, RGB_M_P, RESET, KC_POWER,
